...
namespace OpenNLP.Tools.PosTagger
{
	...
	public class EnglishMaximumEntropyPosTagger : MaximumEntropyPosTagger
	{
        ...
        private static SharpEntropy.IMaximumEntropyModel GetModel(Stream stream)
        {
            return new SharpEntropy.GisModel(new SharpEntropy.IO.BinaryGisModelReader(stream));
        }
    }
